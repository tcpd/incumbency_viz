...
var assemblyNo = params.get('a') ? parseInt(params.get('a')) :4;
...
$('#assemblies option[value="select"').html((assemblyNo == 1 ? "1st" :assemblyNo == 2 ? "2nd" :assemblyNo == 3 ? "3rd" : (assemblyNo + "th")) +  " Assembly").change();


var url = './jh-incumbency-' + assemblyNo + '.csv'; //change json source here

var pids_url = './jh-pids.csv';
...
fixedPartyColours['JMM'] = '#2C7A56';
fixedPartyColours['RJD'] = '#ff005c';
fixedPartyColours['JVM'] = '#009999';
fixedPartyColours['AJSUP'] = '#8e47d2';
fixedPartyColours['SP'] = '#990000';
fixedPartyColours['BSP'] = '#99003d';
fixedPartyColours['CPI(ML)(L)'] = '#333300';
fixedPartyColours['NCP'] = '#ffcc00';
